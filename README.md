...
- Adding LoRAs to Group Self-Attention Preserves Equivariance (see [group_equivariant_attention_2](https://github.com/Amelie-Schreiber/study_of_attention/blob/main/group_equivariant_attention.ipynb))
